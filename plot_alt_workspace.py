...
def plot_alt_working_space(json_file='alt_working_space.json', output_file='alt_working_space_plot.jpeg'):
    # Load the JSON data
    ...
    plt.title('Robot Arm Alternate Working Space')
    plt.legend()
